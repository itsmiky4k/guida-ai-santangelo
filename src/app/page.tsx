    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header { background: #04002A; padding: 24px 20px 20px; text-align: center; border-bottom: 1px solid rgba(28,117,187,0.2); position: sticky; top: 0; z-index: 100; }
        .header-logo { font-size: 10px; letter-spacing: 3px; text-transform: uppercase; color: rgba(255,255,255,0.35); margin-bottom: 6px; }
        .header-title { font-family: 'Cormorant Garamond', serif; font-size: 26px; font-weight: 500; color: #FFFFFF; line-height: 1.2; }
        ...
        .header-subtitle { font-size: 12px; color: rgba(255,255,255,0.35); margin-top: 4px; font-weight: 300; letter-spacing: 0.5px; }
        ...
        .filtro-btn { background: none; border: 1px solid rgba(255,255,255,0.12); border-radius: 20px; padding: 6px 14px; font-size: 12px; color: rgba(255,255,255,0.4); cursor: pointer; white-space: nowrap; font-family: 'Jost', sans-serif; transition: all 0.2s; flex-shrink: 0; }
        ...
        .pannello-card { background: rgba(255,255,255,0.04); border: 1px solid rgba(28,117,187,0.15); border-radius: 14px; overflow: hidden; text-decoration: none; display: flex; align-items: stretch; transition: all 0.2s; cursor: pointer; }
        .pannello-card:hover, .pannello-card:active { background: rgba(28,117,187,0.1); border-color: rgba(28,117,187,0.35); }
        .pannello-numero { width: 52px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-family: 'Cormorant Garamond', serif; font-size: 28px; color: rgba(28,117,187,0.4); border-right: 1px solid rgba(28,117,187,0.1); }
        ...
        .pannello-titolo { font-family: 'Cormorant Garamond', serif; font-size: 18px; font-weight: 500; color: #FFFFFF; line-height: 1.25; margin-bottom: 4px; }
        .pannello-anteprima { font-size: 12px; color: rgba(255,255,255,0.35); line-height: 1.5; font-weight: 300; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
        .pannello-arrow { width: 40px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; color: rgba(28,117,187,0.4); }

        .bottom-bar { position: fixed; bottom: 0; left: 0; right: 0; background: rgba(4,0,42,0.97); backdrop-filter: blur(12px); border-top: 1px solid rgba(28,117,187,0.2); padding: 12px 20px; display: flex; gap: 10px; z-index: 100; }
        ...
        .btn-install { background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); border-radius: 12px; padding: 13px 16px; color: rgba(255,255,255,0.5); font-family: 'Jost', sans-serif; font-size: 12px; cursor: pointer; white-space: nowrap; transition: all 0.2s; }
        .btn-install:hover { color: #fff; border-color: rgba(255,255,255,0.25); }
      `}</style>
